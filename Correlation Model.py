...
dataframe = pd.read_csv('C:\\Users\\Tfarhy\\OneDrive - Network Rail\\2021.01.21_Keras demos\\Correlation Demo\\fv.csv')
dataframe = dataframe.dropna()

     
dataframe = dataframe.drop(columns = ['Unnamed: 0','Date','Geography Description'])
dataframe = dataframe.rename(columns = {'On Time Percentage':'target'})
...
#sns.pairplot(dataframe[['Daily Footfall','Lost Path PfPI','Late Crew PfPI','Late Stock PfPI','On Time Percentage']], diag_kind='kde' ,plot_kws={"s": 2}, height=3)
